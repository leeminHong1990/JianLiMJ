    ...
    initUI: function () {
        ...
        function login_btn_event(sender, eventType) {
            if (eventType === ccui.Widget.TOUCH_ENDED) {
                ...
                KBEngine.app.login(username, password, const_val.sClientDatas);
            }
        }
            ...
            if (eventType === ccui.Widget.TOUCH_ENDED) {
                ...
                if (info_json) {
                    ...
                    if (cc.sys.os === cc.sys.OS_ANDROID) {
                        ...
                        window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx26dce865de785231&redirect_uri=http%3a%2f%2fwww.zhizunhongzhong.com%2fh1hz&response_type=code&scope=snsapi_userinfo&state=" + (new Date() - 0);
                    }
                }
            }
        });
